...
uint32_t TDC7200::readCalibA()
{ 

	uint32_t calibration1 = spiReadReg24(TDC7200_REG_ADR_CALIBRATION1);
	uint32_t calibration2 = spiReadReg24(TDC7200_REG_ADR_CALIBRATION2);
	return calibration1;
}

uint32_t TDC7200::readCalibB()
{ 
	uint32_t calibration1 = spiReadReg24(TDC7200_REG_ADR_CALIBRATION1);
	uint32_t calibration2 = spiReadReg24(TDC7200_REG_ADR_CALIBRATION2);
	return calibration2;
