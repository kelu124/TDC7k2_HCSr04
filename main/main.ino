...
void setup() {
  ...
  if (not tof.setupMeasurement( 10,         // cal2Periods (10) //CALIBRATION2_PERIODS in DS
                                1,          // avgCycles (1) //   AVG_CYCLES = 1 in DS
                                NUM_STOPS,  // numStops (NUM_STOPS) // up to NUM_STOP (000 to 100)
                                2 ))        // mode (2) // @luc: up to 8ms
  {
    M5.Lcd.print("FAIL");
